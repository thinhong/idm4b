...
Model fitting is the process of **adjusting** the model's **parameters** so that the **model's predictions** align **as closely as possible** with **real-world observations**.
...
Basically you use the method to compare the simulated predictions with the observed data points. There are some ways to do that.
