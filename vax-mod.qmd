...
Some vaccines require multiple, like measles (2 doses) or rotavirus (2 doses). Below is the DynaMICE model [@verguet2015] for the 2-dose measles vaccine, assuming AoN effectiveness as in @fig-aon-mod for both doses.
