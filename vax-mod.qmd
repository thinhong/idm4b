...
**All-or-nothing** (AoN, also called the **polarized** [@park2023], or **take** model) model assumes that **among vaccinated** individuals, a **proportion** $VE_P$ are **completely protected**, while **the remaining fraction** $1 - VE_P$ remains **completely unprotected** [@zachreson2023; @park2023].
:::
