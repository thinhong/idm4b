...
coriUserData = {
  ...
  controlsBox.style.cssText = "display:flex;flex-wrap:wrap;gap:10px;align-items:center;margin:0 0 8px;padding:12px 16px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;";

  const exSelect = document.createElement("select");
  exSelect.style.cssText = "flex:1 1 240px;padding:7px 8px;border:1px solid #cbd5e1;border-radius:4px;font-size:13px;background:#fff;";
  ...
  const btnFile  = mkBtn("Upload CSV", "#0891b2", "#fff",    "#0891b2");
  const btnReset = mkBtn("Reset",      "#fff",    "#475569", "#cbd5e1");
  ...
  statusEl.style.cssText = "font-size:13px;color:#16a34a;margin:0 4px 12px;font-weight:600;";
  ...
  fStyle.textContent = `
    ...
    .cori-formula .frac .num { padding:4px 10px 5px; border-bottom:1.5px solid #64748b; border-radius:6px 6px 0 0; }
  ...
  privacyNote.style.cssText = "font-size:12px;color:#64748b;margin-top:14px;padding:8px 12px;background:#f1f5f9;border-left:3px solid #94a3b8;border-radius:3px;";
