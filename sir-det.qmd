...
$$\begin{align} \frac{dS}{dt} & = -\beta SI = -\lambda S \\ \frac{dI}{dt} & = \beta SI - \gamma I = \lambda S - \gamma I \\ \frac{dR}{dt} & = \gamma I \end{align}$$ {#eq-sir}
...
Below is how we numerically solve the differential equations @eq-sir in R with the `odin` package.
