...
odin_mod <- odin({
  ...
  beta <- if (t < t1) beta_1 else if (t >= t1 && t < t2) beta_2 else beta_3
...
seir_mod <- function(beta_1, beta_2, beta_3, t1, t2, sigma, gamma, S0, E0, I0, R0, times = 0:50) {
  odin_run <- odin_mod$new(beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, t1 = t1, t2 = t2, sigma = sigma, gamma = gamma, S_init = S0, E_init = E0, I_init = I0, R_init = R0)
...
mll <- function(beta_1, beta_2, beta_3, sigma, gamma, sd_inc) {
  ...
  pred <- seir_mod(beta_1 = beta_1, beta_2 = beta_2, beta_3 = beta_3, sigma = sigma, gamma = gamma, S0 = S0, E0 = E0, I0 = I0, R0 = R0, times = 0:(length(df$inc) - 1))
  pred <- pred$Inc
  # Return the negative log likelihood
  - sum(dnorm(x = df$inc, mean = pred, sd = sd_inc, log = T))
}

starting_param_val <- list(beta_1 = 0.003, beta_2 = 0.002, beta_3 = 0.003, sigma = 0.5, gamma = 0.5, sd_inc = 3)
...
#| fig-height: 2.5
#| out-width: "100%"
pred <- seir_mod(beta_1 = params[1], beta_2 = params[2], beta_3 = params[3], sigma = params[4], gamma = params[5], S0 = S0, E0 = E0, I0 = I0, R0 = R0, times = df$day)
